    ...
    if (this.recorder == null) {
      ...
      this.recorder.stop().then((result: any) => {
        ...
        fetch(`/api/upload/pitch/range?min-pitch=30.0&max-pitch=300.0`, {
          ...
          .then(function (data) {
            const pitchValues: RawPitchValue[] = (
              data as PitchRangeDTO
            ).pitches.map(
              (item) =>
    ...
    return (
      <div>
        <div className="metilda-page-header">
          <h5>Blackfoot Words {this.pageTitle()}</h5>
        </div>
            ...
            <div className="col s8">
              <div className="metilda-syllable-pitch-art">
                ...
                <div className="pitch-art-controls-container">
                  <button
                    className="waves-effect waves-light btn metilda-btn align-left"
                  ...
                  <div className="pitch-art-btn-container">
                    <button
                      className="waves-effect waves-light btn metilda-btn"
